...
class AnomalyScorer(
    ...
    fun buildBaseline(features: List<FloatArray>): BaselineStats {
        ...
        return BaselineStats(
            mean = mean,
            spread = radius.coerceAtLeast(spreadFloor),
            rawStd = std,
    ...
    fun score(
        ...
        val s = cd / baseline.spread
        val status = MachineStatus.fromScore(s, thresholds.t1, thresholds.t2)
